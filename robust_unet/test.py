...
def inference(args, model, test_save_path=None):
    db_test = args.Dataset(base_dir=args.volume_path,
...
if __name__ == "__main__":
    ...
    if args.model == 'transunet':
        print("Testing on TransUnet!")
        # for transunet
        config_vit = CONFIGS_ViT_seg[args.vit_name]
        config_vit.n_classes = args.num_classes
        config_vit.n_skip = args.n_skip
        config_vit.patches.size = (
            args.vit_patches_size, args.vit_patches_size)
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(
            args.test_save_dir, args.exp, snapshot_name)
